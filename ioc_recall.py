...
class IoCRecall:
    def __init__(self, corpus_list=None):
        self.questions_df = pd.read_csv('/home/paperspace/llama-repo/corpuses/questions_df.csv')
        ...
        self.chroma_client = chromadb.PersistentClient(path="/home/paperspace/llama-repo/data/chroma_db")
    ...
    def get_chunks_and_metadata(self, splitter):
        ...
        for corpus_id in self.corpus_list:
            with open(f'/home/paperspace/llama-repo/corpuses/{corpus_id}.md', 'r') as file:
                corpus = file.read()
