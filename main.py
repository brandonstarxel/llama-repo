...
from chroma_chunkers import ClusterChunker, GregImprovedChunker, LlamaTextChunker, LlamaSlowChunker, LlamaSlowChunker
import os
...
splitter_configurations = [
    ...
    ("None", LlamaSlowChunker, 300, 0, "cl100k_base"),
...
# ioc_recall = IoCRecall(corpus_list=['pubmed'])
...
for name, splitter_type, chunk_size, chunk_overlap, encoding_name in splitter_configurations:
    ...
    elif splitter_type == LlamaSlowChunker:
        splitter = LlamaSlowChunker()
